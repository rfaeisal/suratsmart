-- SuratSmart — DDL manual
-- Jalankan: mysql -u root -p suratsmart < docs/schema.sql
-- Atau import via phpMyAdmin/TablePlus.

CREATE DATABASE IF NOT EXISTS dbsuratsmart CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE dbsuratsmart;
...
INSERT IGNORE INTO settings (`key`, `value`) VALUES
  ('approvalsmart_base_url', ''),
  ('approvalsmart_hmac_key_id', ''),
  ('approvalsmart_hmac_secret', ''),
  ('approvalsmart_legacy_token', ''),
  ('approvalsmart_approver_id', '');
