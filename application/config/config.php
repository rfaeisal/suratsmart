...
|
*/
$config['base_url'] = (isset($_SERVER['HTTP_X_FORWARDED_PROTO']) ? $_SERVER['HTTP_X_FORWARDED_PROTO']
        : (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] !== 'off' ? 'https' : 'http'))
    . '://' . ($_SERVER['HTTP_X_FORWARDED_HOST'] ?? $_SERVER['HTTP_HOST'] ?? 'suratsmart.test') . '/';
...
|
*/
$config['encryption_key'] = getenv('APP_ENCRYPTION_KEY') ?: '22ca92c6f34ca54eb68bcbb2f2036bd4a9f85822a8bcec006d78f036ac8af2bf';
...
|
*/
$config['sess_driver'] = getenv('MYSQLHOST') ? 'database' : 'files';
$config['sess_cookie_name'] = 'ci_session';
$config['sess_samesite'] = 'Lax';
$config['sess_expiration'] = 7200;
$config['sess_save_path'] = getenv('MYSQLHOST') ? 'ci_sessions' : APPPATH . 'sessions';
